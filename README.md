...
### **最新进展：架构深度思考 - 探索 Gemini 级别效能比 (2025-07-19)**
...
*   **核心思考与架构构想**:
    ...
    *   **词表与 MoE 架构的新规划**:
        ...
        2.  **MoE 架构改进**: 我打算在 `qwen3moe` 架构的基础上进行改动，核心是引入 **MLA (Multi-Lookahead Attention) 的注意力机制**，以期提升模型的感知和推理效率。
...
- [ ] **训练器与工程**: 采用 **Muon 训练器**进行训练，探索其在显存节省和不同优化方向上的优势；同时调试 **Megatron-LM** 使其能够稳定训练新架构。
